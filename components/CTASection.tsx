    ...
    <>
      <section className="py-12 sm:py-16 md:py-20 relative">
        <div className="container mx-auto px-4 sm:px-5 md:px-6 lg:px-8">
          <div className="bg-dark-surface border border-gold/30 rounded-lg p-5 sm:p-6 md:p-8 lg:p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="flex items-center justify-center space-x-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-gold text-dark-700 font-semibold rounded hover:bg-gold-600 transition-colors glow-gold-sm relative overflow-hidden group text-sm sm:text-base w-full sm:w-auto"
              >
                <motion.div
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="flex items-center justify-center space-x-2 px-5 sm:px-6 py-2.5 sm:py-3 border-2 border-gold text-gold font-semibold rounded hover:bg-gold/10 transition-colors relative overflow-hidden text-sm sm:text-base w-full sm:w-auto"
              >
                <motion.div
            ...
            <motion.button
              ...
              className="px-6 sm:px-8 py-3 sm:py-4 bg-gold text-dark-700 font-semibold rounded hover:bg-gold-600 transition-colors glow-gold-sm text-base sm:text-lg relative overflow-hidden w-full sm:w-auto"
            >
              <motion.div
