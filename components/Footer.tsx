...
export default function Footer() {
  ...
  const serviceLinks = [
    ...
    href: link.href,
    label:
      t.servicesPage.serviceItems.find((s) => s.id === link.id)?.title ||
      link.id,
  }))

  return (
    <footer className="bg-dark-600 border-t border-gray-800 relative overflow-hidden">
      <div className="container mx-auto px-4 sm:px-5 md:px-6 lg:px-8 py-6 sm:py-8 md:py-10 lg:py-12 relative z-10">
        ...
        <div className="md:hidden">
          ...
          >
            <h3 className="text-white font-semibold mb-4 uppercase text-sm text-center">
              {t.footer.contact}
            </h3>
            <ul className="space-y-3">
              ...
              >
                <a
                  ...
                  className="flex items-center justify-center space-x-3 text-gray-300 hover:text-white transition-colors duration-300 text-base group py-2"
                >
                  <motion.div
                    whileHover={{
                      scale: 1.15,
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          >
            <Link href="/" className="flex items-center space-x-3 mb-3 group">
              ...
              <span className="text-base md:text-lg font-serif text-white group-hover:text-gray-300 transition-colors">
                {t.hero.title}
              </span>
            </Link>
          ...
          >
            <h3 className="text-white font-semibold mb-3 uppercase text-xs sm:text-sm">
              {t.footer.menu}
            </h3>
            <ul className="space-y-1.5 sm:space-y-2">
              {menuLinks.slice(0, 4).map((link, index) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="text-gray-400 hover:text-white transition-colors duration-300 text-xs sm:text-sm group flex items-center py-0.5"
                  >
            ...
            <ul className="space-y-1.5 sm:space-y-2">
              {serviceLinks.slice(0, 3).map((link, index) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="text-gray-400 hover:text-white transition-colors text-xs sm:text-sm group flex items-center py-0.5"
                  >
            ...
            <ul className="space-y-2 sm:space-y-2.5">
              ...
              >
                <a
                  ...
                  className="flex items-center space-x-2 text-gray-400 hover:text-white transition-colors duration-300 text-xs sm:text-sm group py-1"
                >
                  <motion.div
                    whileHover={{
                      scale: 1.15,
                    ...
                    className="flex-shrink-0"
                  >
                    <Phone size={16} className="sm:w-4 sm:h-4 text-gold" />
                  </motion.div>
                  <span className="break-all">
                    {process.env.NEXT_PUBLIC_PHONE || "+380XXXXXXXXX"}
                  </span>
              ...
              >
                ...
                >
                  <motion.div
                    ...
                    className="flex-shrink-0"
                  >
                    <Mail size={16} className="sm:w-4 sm:h-4 text-gold" />
                  </motion.div>
                  <span className="break-all">
                    {process.env.NEXT_PUBLIC_EMAIL || "sarnavsk2001@gmail.com"}
                  </span>
              ...
              >
                ...
                >
                  ...
                  >
                    <MessageCircle
                      size={16}
                      className="sm:w-4 sm:h-4 text-gold"
                    />
                  </motion.div>
                  <span>Telegram</span>
                </a>
