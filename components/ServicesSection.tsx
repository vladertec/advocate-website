        ...
        >
          {t.services.items.map((service, index) => {
            ...
            return (
              ...
              >
                <div className="bg-dark-600 border border-gray-800 rounded-lg p-4 sm:p-5 md:p-6 hover:border-white/50 transition-all hover:shadow-lg h-full relative overflow-hidden">
                  {/* Gradient Background */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${colors[index]} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                  />
