            ...
            return (
              ...
              >
                <Link
                  ...
                  className="block bg-dark-600 border border-gray-800 rounded-lg p-5 sm:p-6 md:p-8 hover:border-white transition-all hover:shadow-lg h-full relative overflow-hidden"
                >
                  ...
                  <div className="relative z-10">
                    <h3 className="text-xl sm:text-2xl font-serif text-white mb-2 sm:mb-3 group-hover:text-white transition-colors">
                      {service.title}
                    </h3>
                    ...
                    <div className="flex items-center text-white group-hover:translate-x-2 transition-transform">
                      ...
                      >
                        <ArrowRight size={20} className="ml-2 text-gold" />
                      </motion.div>
                    </div>
                  </div>
