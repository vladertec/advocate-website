...
export default function BlogSection() {
  ...
  return (
    <section ref={ref} className="py-12 sm:py-16 md:py-20 bg-dark-600">
      <div className="container mx-auto px-4 sm:px-5 md:px-6 lg:px-8">
        ...
        >
          {recentPosts.map((post, index) => (
            <Link
              key={post.slug || index}
              href={`/blog/${post.slug}`}
              className="group bg-dark-600 border border-gray-800 rounded-lg p-4 sm:p-5 md:p-6 hover:border-white transition-all hover:shadow-lg"
            >
        ...
        <div className="text-center mt-8 sm:mt-10 md:mt-12">
          <Link
            href="/blog"
            className="inline-flex items-center space-x-2 px-6 sm:px-8 py-2.5 sm:py-3 border-2 border-white text-white font-semibold rounded hover:bg-white/10 transition-colors relative overflow-hidden group text-sm sm:text-base"
          >
            <motion.div
