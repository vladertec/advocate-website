          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-center">
            ...
            <div className="space-y-4 sm:space-y-6 md:space-y-8 animate-fade-in">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-serif text-white leading-tight">
                {t.landing.title}{" "}
                <span className="text-white">{t.landing.titleHighlight}</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-4">
                <a
                  ...
                  className="flex items-center justify-center space-x-2 px-6 sm:px-8 py-3 sm:py-4 bg-white text-dark-700 font-semibold rounded hover:bg-gray-200 transition-colors  text-sm sm:text-base md:text-lg w-full sm:w-auto"
                >
                  <Phone size={20} className="sm:w-6 sm:h-6 text-gold" />
            ...
            {/* Right Image */}
            <div className="relative h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] rounded-lg overflow-hidden border border-white/20 mt-8 lg:mt-0">
              <Image
