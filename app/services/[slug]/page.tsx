...
export default function ServicePage({ params }: { params: { slug: string } }) {
  ...
  const serviceItem = t.servicesPage.serviceItems.find(
    (s) => s.id === params.slug
  )
  ...
  const details = {
    ...
    howItWorks: [t.serviceDetails.howItWorks + " - " + serviceItem.description],
    whatToDo: [t.serviceDetails.whatToDo],
    faq: [
      {
  ...
  return (
    <>
      <section className="py-20 pt-32 bg-dark-600">
