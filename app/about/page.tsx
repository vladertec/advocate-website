          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 md:gap-12 items-start">
            ...
            >
              <motion.div
                ...
                className="relative h-[250px] sm:h-[300px] md:h-[400px] lg:h-[500px] rounded-lg overflow-hidden border border-gold/20 shadow-2xl"
              >
                <Image
                  src={photos[0]}
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4">
                {photos.slice(1).map((photo, index) => (
                  <motion.div
                    ...
                    className="relative h-32 rounded-lg overflow-hidden border border-gold/20"
                  >
                    <Image
                      src={photo}
            ...
            >
                ...
                {t.about.achievements.map((achievement, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="bg-dark-600 border border-gray-800 rounded-lg p-4 flex items-center space-x-3 hover:border-gold/50 transition-all duration-300"
                    >
                      <motion.div 
                        whileHover={{ rotate: 360 }}
                        transition={{ duration: 0.5 }}
                        className="bg-gold/10 p-2 rounded-lg"
                      >
                        <Icon className="text-gold" size={24} />
                      </motion.div>
                      <span className="text-gray-300 text-xs sm:text-sm">{achievement.text}</span>
                    </motion.div>
                  );
                })}
              </div>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                >
                  <h2 className="text-xl sm:text-2xl font-serif text-gold mb-2 sm:mb-3">{t.about.experience.title}</h2>
                ...
                >
                  <h2 className="text-2xl font-serif text-gold mb-3">{t.about.specialization.title}</h2>
                ...
                >
                  <h2 className="text-2xl font-serif text-gold mb-3">{t.about.approach.title}</h2>
