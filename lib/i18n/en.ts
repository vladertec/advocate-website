...
export const en: Translations = {
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Full support for business in difficult situations",
      },
    ],
  },
  advantages: {
  ...
  quickOffers: {
    title: "Quick Offers",
    subtitle: "Ready solutions for the most common situations",
    details: "Learn More",
  },
  cases: {
  ...
  contact: {
    ...
    workingHoursText: "Available 24/7 for urgent cases",
    sendMessage: "Send Message",
  },
  consultation: {
    title: "Book a Consultation",
    subtitle: "How the consultation process works",
    steps: [
      {
        number: "1",
    ...
    formDescription: "Fill out the form and I will contact you soon",
  },
  cta: {
    title: "Need Help Now?",
    subtitle: "Contact me in any convenient way",
  ...
  form: {
    ...
    error: "Error sending. Please try again or call us directly.",
    required: "required",
    invalidEmail: "Invalid email",
    successMessage: "Request sent successfully! I will contact you soon.",
    errorMessage: "Error sending. Please try again or call directly.",
  },
  about: {
    title: "About",
    name: "Anatoliy Sarnavskiy",
    achievements: [
      { text: "Lawyer since 2012" },
      { text: "30+ years of experience" },
      { text: "Experience as investigator" },
      { text: "Experience in bank security" },
    ],
    experience: {
      title: "Professional Experience",
      text: "Authoritative specialist in articles 190, 191, 368, 369 of the Criminal Code of Ukraine. I have a deep understanding of the specifics of law enforcement agencies and can effectively protect clients' interests.",
    },
    specialization: {
  ...
  footer: {
    ...
    services: "Services",
    contact: "Contact",
    copyright: "© {year} Lawyer Anatoliy Sarnavskiy. All rights reserved.",
  },
  modal: {
    consultation: "Get Consultation",
    close: "Close",
    ...
    serviceItems: [
      {
        id: "anti-obshuk",
        title: "Anti-Search",
        description: "Protection during searches and document seizures",
      },
      {
        id: "audit-191",
        title: "Audit 191 CC",
      ...
      },
      {
        ...
        description: "Comprehensive protection of enterprise executives",
      },
      {
        id: "obshuky-vyimky",
        title: "Searches and Seizures",
        description: "Support during searches and seizures",
      },
      {
        id: "zahyst-190-191",
        title: "Defense under Articles 190, 191 CC",
        description: "Specialized defense in economic crimes",
      },
      {
        id: "zahyst-366-368-369",
        title: "Defense under Articles 366, 368, 369 CC",
        description: "Defense against charges of official crimes",
      },
      {
        id: "konsultatsii",
        title: "Consultations for Executives and Accountants",
        description: "Professional legal consultations",
      },
      {
        id: "audit-ryzykiv",
        title: "Risk Audit",
        description: "Comprehensive audit of business legal risks",
      },
      {
        id: "sprovadzhennya",
      ...
      },
      {
        ...
        description: "Ongoing support and consultations",
      },
    ],
  },
  casesPage: {
    ...
    cases: [
      {
        ...
        actions: [
          ...
          "Prepared comprehensive defense strategy",
      ...
      },
      {
        ...
        actions: [
          ...
          "Documentation of violations by law enforcement",
      ...
      },
      {
        ...
        actions: [
          ...
          "Developed defense strategy",
          "Support during all inspections",
