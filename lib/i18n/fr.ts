...
export const fr: Translations = {
  ...
  advantages: {
    title: "Avantages de la coopération",
    items: [
  ...
  quickOffers: {
    ...
    subtitle: "Solutions prêtes pour les situations les plus courantes",
  ...
  contact: {
    title: "Contact",
    subtitle: "Contactez-moi de manière pratique",
    quickContacts: "Contacts rapides",
    phone: "Téléphone",
    email: "Email",
    telegram: "Telegram",
    workingHours: "Heures de travail",
    workingHoursText: "Disponible 24/7 pour les cas urgents",
    sendMessage: "Envoyer un message",
  },
  consultation: {
    title: "Réserver une consultation",
    subtitle: "Comment fonctionne le processus de consultation",
    steps: [
      {
        number: "1",
    ...
    formDescription: "Remplissez le formulaire et je vous contacterai bientôt",
  },
  cta: {
  ...
  about: {
    ...
    name: "Anatoliy Sarnavskiy",
    achievements: [
      { text: "Avocat depuis 2012" },
      { text: "30+ ans d'expérience" },
      { text: "Expérience en tant qu'enquêteur" },
      { text: "Expérience en sécurité bancaire" },
    ],
    experience: {
      title: "Expérience professionnelle",
      text: "Spécialiste autoritaire des articles 190, 191, 368, 369 du Code pénal ukrainien. J'ai une compréhension approfondie des spécificités des organismes d'application de la loi et peux protéger efficacement les intérêts des clients.",
    },
    specialization: {
  ...
  footer: {
    ...
    services: "Services",
    contact: "Contact",
    copyright: "© {year} Avocat Anatoliy Sarnavskiy. Tous droits réservés.",
  },
  modal: {
    consultation: "Obtenir une consultation",
    close: "Fermer",
  ...
  servicesPage: {
    ...
    serviceItems: [
      ...
      {
        id: "zahyst-kerivnyka",
        title: "Protection des dirigeants",
        description: "Protection complète des dirigeants d'entreprise",
      },
      {
        id: "obshuky-vyimky",
        title: "Perquisitions et saisies",
        description: "Accompagnement lors des perquisitions et saisies",
      },
      {
        id: "zahyst-190-191",
        title: "Défense selon les articles 190, 191 CC",
        description: "Défense spécialisée en crimes économiques",
      },
      {
        id: "zahyst-366-368-369",
        title: "Défense selon les articles 366, 368, 369 CC",
        description: "Défense contre les accusations de crimes officiels",
      },
      {
        id: "konsultatsii",
        title: "Consultations pour dirigeants et comptables",
        description: "Consultations juridiques professionnelles",
      },
      {
        id: "audit-ryzykiv",
        title: "Audit des risques",
        description: "Audit complet des risques juridiques de l'entreprise",
      },
      {
        id: "sprovadzhennya",
      ...
      },
      {
        ...
        description: "Accompagnement et consultations continus",
      },
    ],
  },
  casesPage: {
    ...
    cases: [
      {
        ...
        actions: [
          ...
          "Stratégie de défense complète préparée",
      ...
      },
      {
        ...
        actions: [
          ...
          "Documentation des violations par les forces de l'ordre",
      ...
      },
      {
        ...
        actions: [
          ...
          "Accompagnement lors de toutes les inspections",
  ...
  serviceDetails: {
    howItWorks: "Comment je travaille",
  ...
  landing: {
    ...
    features: [
      {
        title: "24/7",
        description: "Disponibilité 24h/24",
      },
      {
        title: "Rapidement",
        description: "Réaction rapide",
      },
      {
        title: "Confidentiellement",
        description: "Secret absolu",
      },
    ],
  },
  notFound: {
