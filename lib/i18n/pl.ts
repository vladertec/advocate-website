...
export const pl: Translations = {
  ...
  services: {
    ...
    items: [
      {
        title: "Ochrona podczas przeszukań",
        description: "Wsparcie i ochrona podczas przeszukań i zajęć dokumentów",
      },
      {
        title: "Ochrona podczas przesłuchań",
        description: "Profesjonalne wsparcie i ochrona podczas przesłuchań",
      },
      {
      ...
      },
      {
        ...
        description: "Pełne wsparcie biznesu w trudnych sytuacjach",
      },
    ],
  },
  advantages: {
    title: "Zalety współpracy",
    items: [
      { title: "24/7", description: "Dostępność całodobowa" },
      { title: "30+ lat", description: "Doświadczenie zawodowe" },
      { title: "Poufność", description: "Pełna tajemnica" },
      { title: "Doświadczenie w organach", description: "Były śledczy" },
    ],
  },
  quickOffers: {
    title: "Szybkie oferty",
    subtitle: "Gotowe rozwiązania dla najczęstszych sytuacji",
  ...
  contact: {
    title: "Kontakt",
    subtitle: "Skontaktuj się ze mną w wygodny sposób",
    quickContacts: "Szybkie kontakty",
    phone: "Telefon",
    email: "Email",
    telegram: "Telegram",
    workingHours: "Godziny pracy",
    workingHoursText: "Dostępny 24/7 dla pilnych spraw",
    sendMessage: "Wyślij wiadomość",
  },
  consultation: {
    title: "Umów konsultację",
    subtitle: "Jak działa proces konsultacji",
    steps: [
      {
        number: "1",
    ...
    formDescription: "Wypełnij formularz, a wkrótce się z Tobą skontaktuję",
  },
  cta: {
  ...
  about: {
    ...
    name: "Anatoliy Sarnavskiy",
    achievements: [
      { text: "Adwokat od 2012" },
      { text: "30+ lat doświadczenia" },
      { text: "Doświadczenie jako śledczy" },
      { text: "Doświadczenie w bezpieczeństwie bankowym" },
    ],
    experience: {
      title: "Doświadczenie zawodowe",
      text: "Autorytatywny specjalista w zakresie art. 190, 191, 368, 369 Kodeksu Karnego Ukrainy. Mam głębokie zrozumienie specyfiki organów ścigania i mogę skutecznie chronić interesy klientów.",
    },
    specialization: {
      title: "Specjalizacja",
  ...
  servicesPage: {
    ...
    serviceItems: [
      {
        id: "anti-obshuk",
        title: "Anti-Przeszukanie",
        description: "Ochrona podczas przeszukań i zajęć dokumentów",
      },
      {
        id: "audit-191",
        title: "Audyt 191 KK",
        description: "Audyt ryzyka według art. 191 Kodeksu Karnego Ukrainy",
      },
      {
        id: "zahyst-kerivnyka",
        title: "Ochrona kierownictwa",
        description: "Kompleksowa ochrona kierowników przedsiębiorstw",
      },
      {
        id: "obshuky-vyimky",
        title: "Przeszukania i zajęcia",
        description: "Wsparcie podczas przeszukań i zajęć",
      },
      {
        id: "zahyst-190-191",
      ...
      },
      {
        ...
        title: "Obrona według art. 366, 368, 369 KK",
        description: "Obrona przed zarzutami przestępstw służbowych",
      },
      {
        id: "konsultatsii",
        title: "Konsultacje dla kierownictwa i księgowych",
        description: "Profesjonalne konsultacje prawne",
      },
      {
        id: "audit-ryzykiv",
        title: "Audyt ryzyka",
        description: "Kompleksowy audyt prawnych ryzyk biznesu",
      },
      {
        id: "sprovadzhennya",
      ...
      {
        id: "abonentske",
        title: "Usługa abonamentowa",
        description: "Ciągłe wsparcie i konsultacje",
      },
    ],
  },
  casesPage: {
    cases: [
      {
        ...
        actions: [
          ...
          "Przygotowano kompleksową strategię obrony",
      ...
      },
      {
        ...
        actions: [
          ...
          "Ochrona praw klienta podczas przesłuchań",
          "Dokumentowanie naruszeń ze strony organów ścigania",
      ...
      },
      {
        ...
        actions: [
          ...
          "Opracowano strategię obrony",
          "Wsparcie podczas wszystkich kontroli",
  ...
  serviceDetails: {
    howItWorks: "Jak pracuję",
    whatToDo: "Co robić teraz",
  ...
  landing: {
    ...
    features: [
      {
        title: "24/7",
        description: "Dostępność całodobowa",
      },
      {
        title: "Szybko",
        description: "Szybka reakcja",
      },
      {
        title: "Poufnie",
        description: "Pełna tajemnica",
      },
    ],
  },
  notFound: {
