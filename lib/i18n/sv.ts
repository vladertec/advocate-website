...
export const sv: Translations = {
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Professionellt stöd och skydd under förhör",
      },
      {
      ...
      },
      {
        ...
        description: "Fullt stöd för företag i svåra situationer",
      },
    ],
  },
  advantages: {
    title: "Fördelar med samarbete",
    items: [
      { title: "24/7", description: "Tillgänglighet dygnet runt" },
      { title: "30+ år", description: "Arbetserfarenhet" },
      { title: "Konfidentialitet", description: "Fullständig hemlighet" },
      { title: "Erfarenhet i myndigheter", description: "Före detta utredare" },
    ],
  },
  quickOffers: {
    title: "Snabb erbjudanden",
    subtitle: "Färdiga lösningar för de vanligaste situationerna",
    details: "Läs mer",
  },
  cases: {
  ...
  contact: {
    title: "Kontakt",
    subtitle: "Kontakta mig på bekvämt sätt",
    quickContacts: "Snabbkontakter",
    phone: "Telefon",
    email: "Email",
    telegram: "Telegram",
    whatsapp: "WhatsApp",
  ...
  consultation: {
    ...
    subtitle: "Hur konsultationsprocessen fungerar",
    steps: [
      {
        number: "1",
    ...
    formDescription: "Fyll i formuläret så kontaktar jag dig snart",
  },
  cta: {
    title: "Behöver du hjälp nu?",
    subtitle: "Kontakta mig på bekvämt sätt",
    call: "Ring",
    email: "Email",
    telegram: "Telegram",
  ...
  about: {
    ...
    name: "Anatoliy Sarnavskiy",
    achievements: [
      { text: "Advokat sedan 2012" },
      { text: "30+ års erfarenhet" },
      { text: "Erfarenhet som utredare" },
      { text: "Erfarenhet inom banksäkerhet" },
    ],
    experience: {
      title: "Professionell erfarenhet",
      text: "Auktoritativ specialist inom artiklarna 190, 191, 368, 369 i Ukraina strafflag. Jag har en djup förståelse för specifika förhållanden inom brottsbekämpande myndigheter och kan effektivt skydda kundernas intressen.",
    },
    specialization: {
  ...
  servicesPage: {
    ...
    serviceItems: [
      {
        id: "anti-obshuk",
        title: "Anti-Husrannsakan",
        description: "Skydd under husrannsakningar och beslag av dokument",
      },
      {
        id: "audit-191",
        title: "Revision 191 CC",
        description: "Risikorevision enligt artikel 191 i Ukraina strafflag",
      },
      {
        id: "zahyst-kerivnyka",
        title: "Ledningsskydd",
        description: "Omfattande skydd för företagsledare",
      },
      {
        id: "obshuky-vyimky",
        title: "Husrannsakningar och beslag",
        description: "Stöd under husrannsakningar och beslag",
      },
      {
        id: "zahyst-190-191",
        title: "Försvar enligt artiklarna 190, 191 CC",
        description: "Specialiserat försvar i ekonomiska brott",
      },
      {
        id: "zahyst-366-368-369",
        title: "Försvar enligt artiklarna 366, 368, 369 CC",
        description: "Försvar mot anklagelser om tjänstefel",
      },
      {
        id: "konsultatsii",
        title: "Konsultationer för ledare och revisorer",
        description: "Professionella juridiska konsultationer",
      },
      {
        id: "audit-ryzykiv",
        title: "Risikorevision",
        description: "Omfattande revision av företagets juridiska risker",
      },
      {
        id: "sprovadzhennya",
        title: "Deltagande i utredningsåtgärder",
        description: "Stöd under husrannsakningar, förhör och andra åtgärder",
      },
      {
        id: "abonentske",
        title: "Prenumerationsservice",
        description: "Kontinuerligt stöd och konsultationer",
      },
    ],
  },
  casesPage: {
    ...
    cases: [
      {
        ...
        actions: [
          ...
          "Förberedde omfattande försvarsstrategi",
      ...
      },
      {
        ...
        actions: [
          ...
          "Skydd av kundens rättigheter under förhör",
          "Dokumentation av överträdelser av brottsbekämpande myndigheter",
      ...
      },
      {
        ...
        actions: [
          ...
          "Utvecklade försvarsstrategi",
          "Stöd under alla inspektioner",
  ...
  serviceDetails: {
    howItWorks: "Hur jag arbetar",
    whatToDo: "Vad man gör nu",
    faq: "Vanliga frågor",
  },
  common: {
    details: "Detaljer",
  ...
  landing: {
    ...
    features: [
      {
        title: "24/7",
        description: "Tillgänglighet dygnet runt",
      },
      {
        title: "Snabbt",
        description: "Snabb reaktion",
      },
      {
        title: "Konfidentiellt",
        description: "Fullständig hemlighet",
      },
    ],
  },
  notFound: {
